const Map<String, String> ru = {
  ...
  'weekly_pro': 'Еженедельно',
  'monthly_pro': 'Ежемесячно',
  'yearly_pro': 'Ежегодно',
  'lifetime_pro': 'Навсегда',
  'best_deal': '⭐Лучшее предложение',
  'one_time_purchase_desc': 'Разовая покупка навсегда!',
  'cancel_anytime': 'Отмена в любое время',
  'unlock_all_songs': 'Открыть все песни',
  'unlock_all_themes': 'Открыть все темы',
  'unlock_premium_instruments': 'Открыть премиум инструменты',
  'keyboard_recording': 'Запись с клавиатуры',
