const Map<String, String> vi = {
  ...
  'weekly_pro': 'Gói Tuần',
  'monthly_pro': 'Gói Tháng',
  'yearly_pro': 'Gói Năm',
  'lifetime_pro': 'Gói Vĩnh Viễn',
  'best_deal': '⭐Ưu đãi tốt nhất',
  'one_time_purchase_desc': 'Mua một lần, sở hữu mãi mãi!',
  'flash_sale_title': 'FLASH SALE',
  'ends_in': 'Kết thúc sau',
  'hours': 'Giờ',
  'minutes': 'Phút',
  'seconds': 'Giây',
  'sale_50_percent': 'GIẢM 50%',
  'unlock_all_songs': 'Mở khóa tất cả bài hát',
  'unlock_all_themes': 'Mở khóa tất cả giao diện',
  'unlock_premium_instruments': 'Mở khóa nhạc cụ cao cấp',
  'keyboard_recording': 'Thu âm bàn phím',
