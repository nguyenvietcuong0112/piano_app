const Map<String, String> tr = {
  ...
  'monthly_pro': 'Aylık',
  'yearly_pro': 'Yıllık',
  'lifetime_pro': 'Ömür Boyu',
  'best_deal': '⭐En iyi teklif',
  'one_time_purchase_desc': 'Tek seferlik satın alma, sonsuza kadar senin!',
  'cancel_anytime': 'İstediğiniz zaman iptal edin',
  'unlock_all_songs': 'Tüm şarkıların kilidini aç',
  'unlock_all_themes': 'Tüm temaların kilidini aç',
  'unlock_premium_instruments': 'Premium enstrümanların kilidini aç',
  'keyboard_recording': 'Klavye Kaydı',
