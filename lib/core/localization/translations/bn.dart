const Map<String, String> bn = {
  ...
  'weekly_pro': 'সাপ্তাহিক',
  'monthly_pro': 'মাসিক',
  'yearly_pro': 'বার্ষিক',
  'lifetime_pro': 'আজীবন',
  'best_deal': '⭐সেরা অফার',
  'one_time_purchase_desc': 'এককালীন ক্রয়, চিরকালের জন্য আপনার!',
  'cancel_anytime': 'যেকোনো সময় বাতিল করুন',
  'unlock_all_songs': 'সব গান আনলক করুন',
  'unlock_all_themes': 'সব থিম আনলক করুন',
  'unlock_premium_instruments': 'প্রিমিয়াম বাদ্যযন্ত্র আনলক করুন',
  'keyboard_recording': 'কীবোর্ড রেকর্ডিং',
  'premium_features': 'প্রিমিয়াম সুবিধাসমূহ',
